  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51Oru2N094FcsmDOVvAPETAbH31kiXVZTtWudoWeOSNw5ib98JRNmLLbkVXnObCvaU9djvIs9uej85AjwMFUADeBq00Noq6b7LN'); // 1. Get checkout session from API
          _context.next = 4;
